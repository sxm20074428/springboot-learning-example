...
public class UserControllerTest {
    ...
    public void test_log() throws Exception {
        ...
        RequestBuilder request = MockMvcRequestBuilders.get(uri).contentType(MediaType.APPLICATION_JSON_UTF8).accept(MediaType.APPLICATION_JSON);
    ...
    public void test_log_header() throws Exception {
        ...
        String uri = path + "?age=" + age;
        RequestBuilder request = MockMvcRequestBuilders.get(uri).header("username", username).header("password", password).contentType(MediaType.APPLICATION_JSON_UTF8).accept(MediaType.APPLICATION_JSON);
