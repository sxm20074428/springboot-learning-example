...
public class BaseResponse<T>  implements Serializable {
     ...
     * @return ajax对象信息
     */
    public static <T extends Serializable> BaseResponse createSuccessResponse(T data) {
     ...
     * @return ajax对象信息
     */
    public static <T extends Serializable> BaseResponse createSuccessResponse(T data, String msg) {
